...
class ModelRegistry:
    ...
    _models: Dict[str, Dict[str, Any]] = {
        ...
        # OpenRouter Models (Manager & Fallback)
        "nvidia/nemotron-3-ultra": {
            "provider": "openrouter",
            "name": "NVIDIA Nemotron 3 Ultra (free)",
            "capabilities": ["reasoning", "orchestration", "structured", "streaming"],
            "context_window": 128000,
        ...
        "openrouter/free": {
            ...
            "capabilities": ["fallback", "structured", "streaming"],
            "context_window": 128000,
            "input_token_price": 0.0,
            "output_token_price": 0.0,
            "is_embedding": False,
        ...
        # Groq Models (Planner & Research)
        "gpt-oss-20b": {
            "provider": "groq",
            "name": "GPT-OSS 20B (Groq)",
            "capabilities": ["planning", "tool_calls", "fast", "structured"],
        ...
        "llama-3.3-70b": {
            ...
            "capabilities": ["reasoning", "research", "fast", "structured"],
            "context_window": 128000,
            "input_token_price": 0.0,
            "output_token_price": 0.0,
            "is_embedding": False,
        ...
        # Ollama / HuggingFace Local & Open Models (Scraper & Website Analyzer)
        "qwen3:4b": {
            "provider": "ollama",
            "name": "Qwen 3 4B Local",
            "capabilities": ["scraping", "extraction", "fast"],
            "context_window": 32768,
            "input_token_price": 0.0,
            "output_token_price": 0.0,
            "is_embedding": False,
        ...
        "gemma3:12b": {
            "provider": "ollama",
            "name": "Gemma 3 12B Vision & Content Auditor",
            "capabilities": ["vision", "website_analysis", "content_audit"],
            "context_window": 32768,
            "input_token_price": 0.0,
            "output_token_price": 0.0,
            "is_embedding": False,
